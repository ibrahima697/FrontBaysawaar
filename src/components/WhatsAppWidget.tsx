...
const WhatsAppWidget = () => {
    ...
    const phoneNumber = "221788925878";
            ...
            <AnimatePresence>
                {showTooltip && (
                    <motion.div
                        ...
                        className="bg-white text-black px-6 py-3 rounded-2xl shadow-2xl border border-gray-100 relative mb-2 hidden md:block"
                    >
                        ...
                        <p className="text-sm font-bold tracking-tight whitespace-nowrap">
                            Besoin d'aide ? <span className="text-green-600">Contactez-nous</span>
                        </p>
                    </motion.div>
                )}
            </AnimatePresence>
